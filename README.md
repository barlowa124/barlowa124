...
**Upstream contributions:** [TDC fork](https://github.com/barlowa124/TDC) — tested fix for silent dataset-name substitution plus an AnnData getter/split API; [ProteinMPNN fork](https://github.com/barlowa124/ProteinMPNN) — effective-seed visibility fix, filed upstream as [issue #154](https://github.com/dauparas/ProteinMPNN/issues/154).
