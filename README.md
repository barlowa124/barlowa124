...
| [protein-diffusion](https://github.com/barlowa124/protein-diffusion) | DDPM trained on measured-functional GB1 variants; generated candidates scored against the measured oracle, not a surrogate. | The honest negative: 46% of samples are memorized training rows and novel variants score at landscape-random — the model copies, it doesn't generalize. Measured, documented. |
