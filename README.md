...
| [protein-diffusion](https://github.com/barlowa124/protein-diffusion) | DDPM trained on measured-functional GB1 variants; generated candidates scored against the measured oracle, not a surrogate. | The memorization accounting: 8.8% of samples were literally in the training set — the enrichment claim survives because it's measured, not assumed. |
