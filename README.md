...
| [llm-posttraining](https://github.com/barlowa124/llm-posttraining) | SFT + hand-rolled DPO on SmolLM2-135M: abstention-vs-fabrication task, three-stage measured eval on held-out entities. | The negative result: 100% train preference accuracy while deployed behavior collapses two different ways — documented with raw generations. |
